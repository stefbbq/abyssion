...
export function getDashedOrbitsConfig(): GeometricOptions {
  ...
  return {
    radius: 1,
    minRadius: 1, // 0.5x base
    maxRadius: 2, // 1.5x base
    height: 0.5,
    ...
    variationFactor: 1,
    linewidth: 1,
    count: 6, // number of dashed orbits
    zPosition: -1,
  }
}
...
export function getConcentricRingsConfig(): GeometricOptions {
  ...
  return {
    ...
    variationFactor: 1,
    thickness: 0.01,
    count: 6, // number of concentric rings
  }
}
...
export const ORBITAL_PARTICLES_CONFIG: GeometricOptions = {
  radius: 1,
  height: 0.5,
  color: 0x00ffff,
