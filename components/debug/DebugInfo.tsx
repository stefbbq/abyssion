...
export const DebugInfo = (props: Props) => {
  ...
  return (
    <div
      className='bg-black/80 backdrop-blur-sm border border-accent/30 rounded-theme-lg p-3 font-mono text-xs text-text-primary max-w-md max-h-96 overflow-auto'
