 ...
 * renders at bottom-left with theme-aware styling
 */
export const DebugInfo = (props: Props) => {
  ...
  return (
    <div
      className='fixed bottom-4 left-4 glass-effect rounded-lg p-3 font-mono text-xs text-text-primary max-w-md max-h-96 overflow-auto z-50'
