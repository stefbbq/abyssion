...
export default defineRoute(() => {
  ...
  return (
    <>
      ...
      <Shell>
        <TextBlock>
          <p class='text-xl max-w-2xl mx-auto'>Get in touch with us for bookings, collaborations, or just to say hello.</p>
        </TextBlock>
      </Shell>
      ...
      <div class='grid gap-8 lg:grid-cols-2'>
        <Shell>
          ...
          <form class='space-y-6'>
            <div>
              <label for='name' class='block text-sm font-medium mb-2 text-[var(--colors-text-secondary)]'>
                Name
              </label>
              <input
                type='text'
            ...
            <div>
              <label for='email' class='block text-sm font-medium mb-2 text-[var(--colors-text-secondary)]'>
                Email
              </label>
              <input
                type='email'
            ...
            <div>
              <label for='subject' class='block text-sm font-medium mb-2 text-[var(--colors-text-secondary)]'>
                Subject
              </label>
              <input
                type='text'
            ...
            <div>
              <label for='message' class='block text-sm font-medium mb-2 text-[var(--colors-text-secondary)]'>
                Message
              </label>
              <textarea
                id='message'
        ...
        <Shell>
          ...
          <div class='space-y-4'>
            <div class='flex items-center space-x-3'>
              ...
              <div>
                <p class='text-sm text-[var(--colors-text-secondary)]'>Email</p>
            ...
            <div class='flex items-center space-x-3'>
              ...
              <div>
                ...
                <p class='text-[var(--colors-text-primary)]'>Berlin, Germany</p>
              </div>
            </div>
          </div>
        </Shell>
        ...
        <Shell>
          <h2 class='text-2xl font-bold mb-6 text-[var(--colors-text-primary)]'>Follow us</h2>
          <div class='grid grid-cols-2 gap-4'>
            <a
              href='#'
              class='flex items-center space-x-3 p-3 rounded-lg transition-colors border border-[var(--colors-border-primary)]'
            >
              <svg class='w-5 h-5 text-[var(--colors-text-tertiary)]' fill='currentColor' viewBox='0 0 24 24'>
