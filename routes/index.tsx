    ...
    <>
      ...
      <div class='h-screen w-full relative flex flex-col justify-between overflow-hidden bg-black'>
        ...
        <nav class='absolute top-4 right-4 flex space-x-4'>
          <a href='/shows' class='px-3 py-1 text-lg text-white hover:underline'>Shows</a>
          <a href='/bio' class='px-3 py-1 text-lg text-white hover:underline'>Bio</a>
        </nav>
      </div>
    </>
  )
